...
use Destruktiv\UserBundle\Form\DataTransformer\InvitationToCodeTransformer;
...
class InvitationFormType extends AbstractType
{
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'class' => 'Destruktiv\UserBundle\Entity\Invitation',
            'required' => true,
        ));
    }
    ...
    {
        return 'destruktiv_invitation_type';
    }
}
